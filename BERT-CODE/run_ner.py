...
class DataProcessor(object):
    ...
    def _read_data(cls, input_file):
        """Reads a BIO data."""
        inpFilept = open(input_file, encoding='windows-1252')
        # inpFilept = pd.read_csv(input_file, encoding= 'unicode_escape')
        # inpFilept = open(input_file).decode('ISO-8859-1')
        lines = []
        words = []
        labels = []
        # print("-d-d-d-d-d-d-d-d-d-d-d-d-d-d-d-d-d-d-d-d-d-d-d-d-d-d-d-d-d-d-d-d-d-d-d-d-d-d-d-d-d-d-d-d-d-d-d-d-d-d-d-d-d-d-d-d-d-d-d")
        # print(inpFilept)
        # print(enumerate(inpFilept)[0])
        # for ind, li in enumerate(inpFilept):
        #   print(li)
        #   print(li.splitlines())
        #   print(li.splitlines()[0].split())
        #   print(" -d-d-d-d-d------------------")
...
class NerProcessor(DataProcessor):
    ...
    def get_labels(self):
        ...
        return ["[PAD]", "B-Drug", "B-Reason", "B-Ade", "I-Drug", "I-Reason", "I-Ade", "O", "X", "[CLS]", "[SEP]"] 
        # return ["[PAD]","B", "I", "B-Drug", "B-Reason", "B-Ade", "I-Drug", "I-Reason", "I-Ade", "O", "X", "[CLS]", "[SEP]"] 
...
def main(_):
    ...
    if FLAGS.do_train:
        ...
        num_train_steps = int(
            len(train_examples) / FLAGS.train_batch_size * FLAGS.num_train_epochs) + 1
